...
angular.module('ControladorApp', [])
  ...
  .controller('MoInicioCtrl', function ($scope, $ionicLoading, $rootScope, ServiciosRuat,
                                        $ionicPopup, $ionicHistory, $state, $ionicPlatform, $location, $ionicBackdrop, $timeout, $cordovaDevice) {
