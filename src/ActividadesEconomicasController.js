...
angular.module('ControladorActividadesEconomicas', [])
    .controller('AeBusGralCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope, ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state) {
    ...
    $scope.buscarActividad = function (identificador, criterio, codAlcaldia) {
    ...
    .controller('AeBusDetCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope, ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state) {
    $scope.$on("$ionicView.enter", function () {
        $ionicHistory.clearCache();
        $ionicHistory.clearHistory();
    });
    ...
    $scope.buscarDetalle = function (identificador, criterio, codAlcaldia, nroIdentificacion) {
        $rootScope.numActEco = identificador;
        ServicioDatos.data = {
            identificador: identificador,
            codAlcaldia: codAlcaldia,
    ...
    .controller('AeDatosGralCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope, ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state) {
    $scope.showLoadingProperTimes = function () {
        $ionicLoading.show({
            templateUrl: "templates/mo-spinner.html",
            content: 'Loading',
    ...
    .controller('AeDatosDetCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope, ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state) {
    $scope.showLoadingProperTimes = function () {
        $ionicLoading.show({
            templateUrl: "templates/mo-spinner.html",
            content: 'Loading',
