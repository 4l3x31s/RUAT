...
angular.module('ControladorInmuebles', [])
    .controller('InmBusGralCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope, ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state) {
    ...
    $scope.buscarInmueble = function (numInmueble, codAlcaldia) {
    ...
    .controller('InmDatosGralCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope, ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state) {
    $scope.$on("$ionicView.enter", function () {
        $ionicHistory.clearCache();
    });
    $scope.showLoadingProperTimes = function () {
    ...
    .controller('InmGrillaGeneral', function ($scope, $ionicActionSheet, $timeout, $rootScope, ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state) {
    $scope.$on("$ionicView.enter", function () {
        $ionicHistory.clearCache();
    });
    ...
    .controller('InmBusDetCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope, ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state) {
    if ($rootScope.numInmueble != null) {
        $scope.identificadorInm = $rootScope.numInmueble;
    }
    else {
    ...
    $scope.buscarInmueble = function (numInmueble, codAlcaldia, docIdentidad) {
        if ($rootScope.numInmueble == '') {
            if (numInmueble != null) {
                $rootScope.numInmueble = numInmueble;
            }
    ...
    .controller('InmDatosDetCtrl', function ($scope, $ionicActionSheet, $timeout, $rootScope, ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state) {
    $scope.$on("$ionicView.enter", function () {
        $ionicHistory.clearCache();
    });
    $scope.showLoadingProperTimes = function () {
    ...
    .controller('InmGrillaDetalle', function ($scope, $ionicActionSheet, $timeout, $rootScope, ServiciosRuat, ServicioDatos, $location, $ionicLoading, $ionicPopup, $ionicHistory, $state) {
    $scope.$on("$ionicView.enter", function () {
        $ionicHistory.clearCache();
    });
    $scope.listaInmuebles = ServicioDatos.data.listaInmuebles;
